...
public class DAOCargo extends DAOGenerico<Cargo> {
    ...
    public List<Cargo> listById(int id) {
        return em.createQuery("SELECT e FROM Cargo + e WHERE e.idCargo= :id").setParameter("id", id).getResultList();
    }
    ...
    public static void main(String[] args) {
        ...
        for (Cargo Cargo : listaCargo) {
            System.out.println(Cargo.getIdCargo()+ "-" + Cargo.getNomeCargo()+ "-" + Cargo.getRenda());
        }
    }
}
